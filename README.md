...
> **⚠️ 免责声明：本工具仅供学习研究，不是投资建议。详见 [DISCLAIMER.md](./DISCLAIMER.md)**
...
将 `skills/` 目录下的所有文件夹复制到你的 AI 助手技能目录即可。
...
**本工具仅供学习和研究使用，不构成任何形式的投资建议。**

投资有风险，入市需谨慎。使用本工具即表示你同意：
- 独立做出投资决策，自行承担投资风险
...
使用本工具即表示你同意 [免责声明](./DISCLAIMER.md) 中的所有条款。
