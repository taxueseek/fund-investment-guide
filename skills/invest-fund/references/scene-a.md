...
> 超额对标基准：统一用基金合同载明的「业绩比较基准」，不按类型拍脑袋映射——基准是经理自选的战场，揭示他把自己和谁比（如基准=沪深300→能力圈在A股大盘；含中债指数→攻守兼备；基准与策略不符要追问）。锚点原则详见 scene-c。
...
| 诊断标签 | 五选一：优质成长 / 估值合理 / 困境反转 / 趋势博弈 / 踩雷预警 | 选「踩雷预警」必须标注预警信号 |
...
对每只重仓股标注持续持有季度数，识别哪些是真正的核心仓位，哪些是波段试探。
...
| 1只 | 微调 | 观望状态，持股信心强 |
| 2-3只 | 常规调整 | 优化结构，正常运作 |
| 4只及以上 | 重大转向 | 策略变化，需重点关注 |

结合业绩看调仓效果：调仓后新增股票3个月内跑赢基准 → 调仓有效；频繁大调但业绩无改善 → 追涨杀跌嫌疑。 
