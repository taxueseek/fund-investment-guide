---
name: invest-us
description: invest 系列：美股价值投资分析框架。通过4大核心维度（ROE持续性、负债安全性、自由现金流质量、护城河评估）对上市公司进行系统性价值评估，输出 A-D 投资评级。当用户提到某只美股是否值得长期持有、价值投资筛选、ROE分析、护城河评估、巴菲特选股标准等话题时触发。与 invest-report 互补——invest-report 侧重单份财报深度拆解，本技能侧重跨周期的长期价值四维评分。
---
